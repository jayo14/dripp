    ...
    <div className="grid min-h-[calc(100vh-4rem)] grid-cols-1 lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center px-6 py-16 lg:px-16">
        ...
        >
          ...
          <p className="mt-8 text-[11px] uppercase tracking-luxury text-muted-foreground">{eyebrow}</p>
          <h1 className="mt-3 text-4xl font-light tracking-tight text-foreground">{title}</h1>
